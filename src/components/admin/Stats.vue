...
export default {
  ...
  methods: {
    async fetchStats() {
      try {
        const response = await axios.get('http://115.235.142.254:3000/api/stats');
    ...
    async fetchWinRateLeaderboard() {
      try {
        const response = await axios.get('http://115.235.142.254:3000/api/winRateLeaderboard');
    ...
    async fetchGamesPlayedLeaderboard() {
      try {
        const response = await axios.get('http://115.235.142.254:3000/api/gamesPlayedLeaderboard');
