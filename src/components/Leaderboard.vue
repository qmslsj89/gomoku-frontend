  ...
  export default {
    ...
    methods: {
      async fetchWinRateLeaderboard() {
        try {
          const response = await axios.get('http://115.235.168.136:3000/api/winRateLeaderboard');
      ...
      async fetchGamesPlayedLeaderboard() {
        try {
          const response = await axios.get('http://115.235.168.136:3000/api/gamesPlayedLeaderboard');
