...
socket.js
 ...
 文件与 Socket.IO 服务器进行连接和通信，实现实时游戏消息的传递。
...
socket.js
 ...
 文件中定义与 Socket.IO 服务器的连接和事件处理。
2. 在 

GomokuBoard.vue

 组件中初始化 Socket.IO 连接，并监听游戏消息。
